...
===============================
Train on Goal environment using LIRL algorithm
...
class ActionProjection:
    ...
    Goal environment action space:
    - 3 discrete actions: kick_to(0), shoot_goal_left(1), shoot_goal_right(2)
    - Continuous parameters: kick_to needs 2 parameters (x,y), shoot_goal_left/right each need 1 parameter
    """
    ...
    def project(self, action_probs, action_params, record_timing=True):
        ...
        Args:
            ...
            action_params: Continuous action parameters [4]
    ...
    def _select_discrete_action(self, action_probs):
        ...
        For Goal environment, we build a cost matrix to select optimal action
        """
    ...
    def _project_continuous_params(self, action_params, discrete_action):
        ...
        Args:
            action_params: Original continuous parameters [4]
