...
class PADDPGAgent(Agent):
    ...
    def __init__(self,
        ...
        self.noise = OrnsteinUhlenbeckActionNoise(self.action_parameter_size, random_machine=self.np_random, mu=0., theta=0.15, sigma=0.2)
    ...
    def act(self, state):
        with torch.no_grad():
            ...
            if len(all_action_parameters.shape) > 1:
